    ...
    <div class ="container">
       <div class ="form-horizontal">
           ...
           <div class ="form-group">
               ...
               <div class ="col-md-3">
                   <asp:DropDownList ID="ddlGender" CssClass ="form-control" AutoPostBack="true" runat="server" OnSelectedIndexChanged="ddlGender_SelectedIndexChanged"></asp:DropDownList>
               </div>
           </div>
            ...
            <div class ="form-group">
               ...
               <div class ="col-md-3">
                   <asp:CheckBoxList ID="cblSize"  CssClass ="col-md-2 control-label" runat="server"></asp:CheckBoxList>
               </div>
           </div>
