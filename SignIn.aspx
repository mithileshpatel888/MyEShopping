                ...
                <%--- for forgot password---%>
                 ...
                 <div class ="form-group">
                    ...
                    <div class ="col-md-6 ">
                        ...
                        <asp:HyperLink ID="HyForgotPass" runat="server" NavigateUrl="~/ForgotPaswword.aspx">Forgot Password</asp:HyperLink>
                  ...
                  <div class ="form-group">
                    ...
                    <div class ="col-md-6 ">
                        ...
                        <asp:Label ID="lblError" CssClass="text-denger" runat="server" ></asp:Label>
